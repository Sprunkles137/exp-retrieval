...
execute positioned ~-32 ~-32 ~-32 as @a[dx=64,dy=64,dz=64] if score @s bloodstain_id = current bloodstain_id if score @s bloodstain_deathcount = current bloodstain_deathcount run scoreboard players set temp bloodstain_var 1
